...
public class CohortsDAO {
	...
	private void openDB() {
	  ...
	  public ArrayList<Cohorts> getAllCohorts() {
		  ...
		  Cursor returnData = readDatabase.query(Cohorts.COHORTS_TABLE, columns, null, null, null, null, null);
	  ...
	  /*
	   * Method to get a particular cohort given its ID.
	   * Mainly used to modify the existing cohort.
	   */
	  public Cohorts getCohortWithID(int id) {
		  ...
		  Cursor returnData = readDatabase.query(Cohorts.COHORTS_TABLE, columns, where, null, null, null, null);
	  ...
	  /*
	   * Method to update/modify an existing cohort.
	   * This will use cohort ID in where clause.
	   */
	  ...
	  public int deleteCohort(Cohorts cohort) {
		  ...
		  int numRemoved = writeDatabase.delete(Cohorts.COHORTS_TABLE, where, null);
